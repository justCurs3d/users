...
export const User = ({item, handleInvite, invites}) => {
  return (
  <li>
    <div>
    ...
    <img className="action" src={invites.includes(item.id) ? "/assets/minus.svg" : "/assets/plus.svg"} onClick={() => handleInvite(item.id)} alt="Action" />
  </li>
)};
